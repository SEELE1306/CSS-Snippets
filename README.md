...
[Saltssaumure](https://github.com/Saltssaumure), [Lexia](https://github.com/exterpolation), [CichyCze](https://github.com/CichyCze), [UzinSG](https://github.com/UzinSG) for various elements within the snippets!
